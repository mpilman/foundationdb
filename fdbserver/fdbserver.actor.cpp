...
enum {
	...
	OPT_LOGGROUP, OPT_LOCALITY, OPT_IO_TRUST_SECONDS, OPT_IO_TRUST_WARN_ONLY, OPT_FILESYSTEM, OPT_KVFILE, OPT_TRACE_FORMAT, OPT_USE_OBJECT_SERIALIZER };
...
int main(int argc, char* argv[]) {
	try {
		...
		// 0 = off, 1 = on, 2 = random (for simulator only)
